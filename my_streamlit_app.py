...
continent_cars = st.radio('Choisissez une région :', ('US', 'Europe', 'Japan'))
if continent_cars == 'US.':
    df_cars = df_cars[df_cars.continent == 'US.']
if continent_cars == 'Europe.':
    df_cars = df_cars[df_cars.continent == 'Europe.']
if continent_cars == 'Japan.':
    df_cars = df_cars[df_cars.continent == 'Japan.']


st.write('Les voitures les plus puissantes sont américaines.')
